        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-xl text-gray-300 leading-relaxed mb-8 max-w-3xl">
              NHBRC registration is in progress. This page will go live with full registration details upon confirmation.
            </p>
          </div>
        </div>
      </section>
            ...
            <div>
              <div className="bg-gradient-to-br from-orange-500 to-yellow-500 rounded-2xl p-10 text-black mb-8">
                ...
                <p className="text-lg leading-relaxed mb-6">
                  NHBRC registration is in progress. This page will be updated with full registration details upon confirmation.
                </p>
              ...
              <div className="bg-gray-50 border-2 border-gray-200 rounded-xl p-8">
                ...
                <ul className="space-y-3 text-gray-700">
                  ...
                  <li><strong>NHBRC Registration:</strong> In progress</li>
                </ul>
              </div>
            </div>
          </div>
