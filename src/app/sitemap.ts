...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: 'https://www.afripact.net/renovations/hospitality',   priority: 0.9,  changeFrequency: 'monthly' },
    { url: 'https://www.afripact.net/renovations/office',        priority: 0.9,  changeFrequency: 'monthly' },
    { url: 'https://www.afripact.net/renovations/retail',        priority: 0.85, changeFrequency: 'monthly' },
    ...
    { url: 'https://www.afripact.net/blog',                                            priority: 0.8,  changeFrequency: 'weekly'  },
    { url: 'https://www.afripact.net/blog/bathroom-renovation-cost-durban',            priority: 0.65, changeFrequency: 'monthly' },
    { url: 'https://www.afripact.net/blog/kitchen-renovation-pietermaritzburg-guide',  priority: 0.65, changeFrequency: 'monthly' },
    { url: 'https://www.afripact.net/blog/how-to-choose-renovation-contractor-kzn',   priority: 0.65, changeFrequency: 'monthly' },
